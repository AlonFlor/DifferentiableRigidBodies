...
def get_actual_mass_and_com():
    count = 0
    mass = 0.
    loc_weighed_mass = np.array([0., 0., 0.])
    for i in range(87):
...
def try_a_force_pair(first_force, second_force):
    ...
    velocity, angular_velocity = run_pybullet_one_time_step(first_force, second_force)

    return velocity, angular_velocity[2]
...
def find_balancing_external_force_pair(first_force_magn, pos1, dir1, pos2, dir2):
    ...
    velocity_result, angular_velocity_result = try_a_force_pair([(dir1[0]*first_force_magn, dir1[1]*first_force_magn, dir1[2]*first_force_magn), pos1],
