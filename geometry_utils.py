...
def to_world_coords(shape, vertex):
    return rotation_from_quaternion(shape.orientation, vertex - shape.center) + shape.center + shape.location
...
def to_local_coords(shape, world_vertex):
    return rotation_from_quaternion(quaternion_inverse(shape.orientation), world_vertex - shape.center - shape.location) + shape.center
...
def velocity_of_point(shape, world_vertex):
    return shape.velocity + np.cross(shape.angular_velocity, world_vertex - shape.location - shape.center)
